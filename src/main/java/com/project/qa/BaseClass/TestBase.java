package com.project.qa.BaseClass;
...
import com.project.qa.Utilities.SendEmail;
import com.project.qa.Utilities.TestUtility;
import com.project.qa.Utilities.WebEventListener;
...
public class TestBase
{
	...
	public TestBase() //Constructor to read data from property file.
	{
		...
		try 
		{
			...
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/project/qa/Configuration/Configuration.properties");
			property.load(ip);
		} 
	...
	public void setExtent()
	{
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "/ExtentResults/ExtentReport.html",true);
		extent.addSystemInfo("Host Name", "Windows System");
		extent.addSystemInfo("User Name", "Jithin");
	...
	public void cleanupSuite() {
		Runtime.getRuntime().addShutdownHook(new Thread() {String AttachFile = "./ExtentResults/ExtentReport.html"; public void run() { try {
			  SendEmail.mailsend(AttachFile); } catch (IOException e) { e.printStackTrace();
			  } } });
    } 
}
